<template>
    <div>
        <!-- Hero -->
        <base-page-heading title="Dienstplan">
            <!-- <template #extra>
                <b-breadcrumb class="breadcrumb-alt">
                    <b-breadcrumb-item href="javascript:void(0)"
                        >Plugins</b-breadcrumb-item
                    >
                ...
                <b-row class="items-push">
                    ...
                    <b-col md="4" lg="5" xl="3">
                        ...
                        <ul id="calendar-events" class="list list-events">
                            ...
                            >
                                <div
                                    class="js-event p-2 font-size-sm font-w600 text-white"
                        ...
                        <div class="text-center">
                            <em class="font-size-sm text-muted">
                                <i class="fa fa-arrows-alt"></i> Drag and drop
